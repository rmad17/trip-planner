...
func RouterGroupExpenses(router *gin.RouterGroup) {
	...
	router.GET("/:trip_plan_id/expenses", GetExpenses)               // GET /trip-plans/:id/expenses
	router.POST("/:trip_plan_id/expenses", CreateExpense)            // POST /trip-plans/:id/expenses
	router.GET("/:trip_plan_id/expense-summary", GetExpenseSummary)  // GET /trip-plans/:id/expense-summary

	// Settlements nested under Trip Plans
	router.GET("/:trip_plan_id/settlements", GetSettlements)      // GET /trip-plans/:id/settlements
	router.POST("/:trip_plan_id/settlements", CreateSettlement)   // POST /trip-plans/:id/settlements
}
